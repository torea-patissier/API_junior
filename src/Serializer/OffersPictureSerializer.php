...
final class OffersPictureSerializer implements ContextAwareNormalizerInterface, NormalizerAwareInterface
{
  ...
  public function normalize($object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
  {
    ...
    if ($this->storage->resolveUri($object, 'photoFile')) {
      $object->setImage($this->storage->resolveUri($object, 'photoFile'));
    }
